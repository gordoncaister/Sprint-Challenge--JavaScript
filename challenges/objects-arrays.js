...
const unisWithUni = graduates.filter( x => x.university.match(/Uni+/g));
...
const lowCaseAnimalNames = zooAnimals.map( z => z.animal_name.toLowerCase());
...
*/
const lowPopulationAnimals = zooAnimals.filter( y => y.population<5);
